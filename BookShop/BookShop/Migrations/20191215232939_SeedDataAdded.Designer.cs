...
namespace BookShop.Migrations
{
    ...
    [Migration("20191215232939_SeedDataAdded")]
            ...
            modelBuilder.Entity("BookShop.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ShortDescription = "Python is a powerful, expressive programming language that's easy to learn and fun to use!"
                        },
                        new
                        {
                            BookId = 4,
                            ...
                            ShortDescription = "Functional programming is rooted in lambda calculus, which constitutes the world's smallest programming language. "
                        },
                        new
                        {
                            BookId = 5,
                            ...
                            Name = "The Computer Book : From the Abacus to Artificial Intelligence",
                            Paid = false,
                            Price = 13.95m,
                            ReleaseYear = "06 Nov 2018",
                            ShortDescription = "Part of Sterling's extremely popular Milestones series, this illustrated exploration of computer science ranges from the ancient abacus to superintelligence and social media."
                        },
                        new
                        {
                            BookId = 6,
                            CategoryId = 2,
                            ImageThumbnailUrl = "https://i.ibb.co/2th91z6/9780007284870.jpg",
                            ...
                            ShortDescription = "Ben Goldacre's wise and witty bestseller, shortlisted for the Samuel Johnson Prize, lifts the lid on quack doctors, flaky statistics, scaremongering journalists and evil pharmaceutical corporations."
                        },
                        new
                        {
                            BookId = 7,
                            ...
                            Name = "Steal This Computer Book 4.0",
                            Paid = false,
                            Price = 21.44m,
                            ReleaseYear = "05 Jun 2006",
                            ShortDescription = "If you thought hacking was just about mischief-makers hunched over computers in the basement, think again"
                        },
                        new
                        {
                            BookId = 8,
                            ...
                            ShortDescription = "Exploring more than 80 of the world's most scientific theories and big ideas."
                        },
                        new
                        {
                            BookId = 9,
                            ...
                            Name = "AQA Computing A2: Student Book",
                            Paid = false,
                            Price = 32.95m,
                            ReleaseYear = "01 Nov 2014",
                            ShortDescription = "AQA Computing offers complete coverage and support through a variety of truly blended printed and online resources."
                        },
                        new
                        {
                            BookId = 10,
                            ...
                            ShortDescription = "A simple, straightforward guide to the fundamentals of technical analysis Technical analysis is a collection of techniques designed to help you make trading decisions in securities markets."
                        },
                        new
                        {
                            BookId = 11,
                            ...
                            ShortDescription = "The Technical Writing Process is a simple, five-step process that can be used to create almost any piece of technical documentation such as a user guide, manual or procedure."
                        });
                });
